...
func (r *recordingStore) Create(_ context.Context, in Input) (Trip, error) {
...
func TestCreateValidation(t *testing.T) {
	...
	repo := &recordingStore{}
	_, err := NewService(repo).Create(context.Background(), valid)
	if err != nil || !repo.called || repo.input.Name != "Cebu trip" {
